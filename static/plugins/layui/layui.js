/*! 2.6.8 | MIT Licensed */ !(function (t) {
  ...
  var e = t.document,
    ...
    l = (n.builtin = {
      ...
      jquery: "jquery",
      all: "all",
      "http://res.layui.com/layui/dist/layui.all":
        "http://res.layui.com/layui/dist/layui.all",
    });
  (r.prototype.cache = n),
    ...
    (r.prototype.use = function (r, o, c, s) {
      ...
      if (
        ...
        0 === r.length ||
          (layui["http://res.layui.com/layui/dist/layui.all"] && l[h]))
      )
        return f(), y;
      var g =
        (l[h]
...
layui.define(function (a) {
  ...
  layui.config({ dir: i.dir.replace(/lay\/dest\/$/, "") }),
    a("http://res.layui.com/layui/dist/layui.all", layui.v);
});
!(function (t) {
  "use strict";
  var e = "lay",
  ...
  (i.prototype = []),
    ...
    (r.position = function (e, i, o) {
      if (i) {
        ...
        "center" === o.align
          ? (h -= (u - e.offsetWidth) / 2)
          : "right" === o.align && (h = h - u + e.offsetWidth),
    ...
    (i.prototype.find = function (t) {
      ...
      return (
        this.each(function (r, c) {
          for (
            var u = o ? c.contains(t) : c.querySelectorAll(t || null);
            n < u.length;
            n++
          )
            i.push(u[n]);
...
!(function (e, t) {
  ...
  !(function () {
    ...
    (e.innerHTML =
      "  <link/><table></table><a href='http://res.layui.com/a'>a</a><input type='checkbox'/>"),
  ...
  (p.prototype.config = {
    ...
    (p.prototype.events = function () {
      ...
      i.elem.off("upload.start").on("upload.start", function () {
        ...
        (o.ie && o.ie < 10) ||
          i.elem
            .off("http://res.layui.com/layui/dist/upload.over")
            .on("http://res.layui.com/layui/dist/upload.over", function () {
              var e = t(this);
              e.attr("lay-over", "");
            })
            .off("upload.leave")
            ...
            .off("http://res.layui.com/layui/dist/upload.drop")
            .on("http://res.layui.com/layui/dist/upload.drop", function (n, o) {
              var r = t(this),
          ...
          i.drag &&
            i.elem
              .on("dragover", function (e) {
                e.preventDefault(),
                  t(this).trigger(
                    "http://res.layui.com/layui/dist/upload.over"
                  );
              })
              ...
              .on("drop", function (e) {
                e.preventDefault(),
                  t(this).trigger(
                    "http://res.layui.com/layui/dist/upload.drop",
                    e
                  );
              }),
...
layui.define(
  ["lay", "laytpl", "laypage", "layer", "form", "util"],
  function (e) {
    "use strict";
    var t = layui.$,
      ...
      F = [
        '<div class="layui-form layui-border-box {{ d.VIEW_CLASS }} {{ d.VIEW_CLASS }}-{{ d.index }}{{# if(d.data.className){ }} {{ d.data.className }}{{# } }}" lay-filter="LAY-TABLE-FORM-DF-{{ d.index }}" lay-id="{{ d.data.id }}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">',
        "{{# if(d.data.toolbar){ }}",
    ...
    (H.prototype.config = {
      ...
      (H.prototype.render = function () {
        ...
        var l = a.elem,
          n = l.next("." + m),
          o = (e.elem = t(
            i(F).render({ VIEW_CLASS: m, data: a, index: e.index })
          ));
        if (
          ((a.index = e.index),
          (e.key = a.id || a.index),
      ...
      (H.prototype.renderData = function (e, n, o, r) {
        var d = this,
          ...
          b = function () {
            var e;
            return !r && d.sortKey
              ? d.sort(d.sortKey.field, d.sortKey.sort, !0)
              : (layui.each(u, function (a, l) {
                  ...
                  ("array" === layui._typeof(l) && 0 === l.length) ||
                    ...
                    f.push(
                      '<tr data-index="' + a + '">' + o.join("") + "</tr>"
                    ),
                    m.push(
                      '<tr data-index="' + a + '">' + u.join("") + "</tr>"
                    ),
                    g.push(
        ...
        return (
          ...
          0 === u.length
            ? (d.renderForm(), d.errorView(s.text.none))
            : (d.layFixed.removeClass(p),
              r
                ? b()
                : (b(),
                  d.renderTotal(u, h),
                ...
                '<td data-field="' +
                  ...
                  (function () {
                    ...
                    return (
                      ...
                      d.minWidth &&
                        e.push('data-minwidth="' + d.minWidth + '"'),
                      e.join(" ")
                    );
                  })() +
                  ' class="' +
                ...
                '<div class="layui-table-cell laytable-cell-' +
                  ...
                  (function () {
                    ...
                    return "string" == typeof e
                      ? i(e).render(t.extend({ TOTAL_NUMS: s }, d))
                      : s;
                  })(),
                "</div></td>",
              ].join("");
      ...
      (H.prototype.sort = function (e, i, a, l) {
        ...
        (d.sortKey = { field: n, sort: i }),
          u.autoSort &&
            ("asc" === i
              ? (o = layui.sort(f, n))
              : "desc" === i
              ? (o = layui.sort(f, n, !0))
              : ((o = layui.sort(f, c.config.indexName)), delete d.sortKey)),
        ...
        return (
          layui.each(l, function (e, l) {
            return "array" === layui._typeof(l)
              ? void i++
              : void (
                  l[c.config.checkName] && (t++, a.push(c.clearCacheKey(l)))
                );
          }),
